...
% GEOMBEST is a morphological-behavior model that simulates barrier island evolution in response to changes in sea level and sediment supply rates; this version of the model includes seagrass dynamics in the back-barrier bay.

% Copyright (C) 2019 Ian R.B. Reeves (current developer)
